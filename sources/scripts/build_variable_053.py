#!/usr/bin/env python3
"""Postprocess Local 0.53 statics and build compatible wght variables."""
...
DIST = ROOT / "build/0.53"
DESIGNSPACES = ROOT / "build/designspace-0.53"
...
def normalize_metadata(
    ...
    set_name(font, 3, f"0.530;SKFT;{postscript}")
    set_name(font, 4, full)
    set_name(font, 5, "Version 0.530")
