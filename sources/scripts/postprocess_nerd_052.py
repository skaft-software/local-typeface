#!/usr/bin/env python3
"""Restore Local Mono core outlines after Nerd Font icon patching."""
...
def process(style: str) -> Path:
    ...
    set_name(nerd, 3, f"0.520;SKFT;{postscript}")
    set_name(nerd, 4, full)
    set_name(nerd, 5, "Version 0.520")
