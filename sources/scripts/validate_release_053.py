#!/usr/bin/env python3
"""Validate the installable Local 0.53 consistency-pass artifacts."""
...
def check_metadata(
    ...
    require(name(font, 5) == "Version 0.530", f"{family}: version")
...
def main() -> None:
    ...
    check_nerd()
    print("PASS  Local 0.53 statics, variables, webfonts, and Nerd Fonts")
